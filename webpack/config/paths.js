...
const appPaths = {
  ...
  // путь к папке со стилями библиотеки компонентов
  appStylesPackage: path.resolve(__dirname, '../../styles-package'),
  // путь к файлу с настройками stylelint
  appStylelintConfig: path.resolve(__dirname, '../../.stylelintrc.js'),
};
